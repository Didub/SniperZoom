/*
* SniperZoom Copyright 2015 Rodrigo Jimenez
*
* Licensed under MIT (http://opensource.org/licenses/MIT)
*
*/
(function ($) {
	$.fn.sniperZoom = function( options ) {
		...
		var plugin = {
			...
			*/
			styleElements: function(){
				...
				// check if randomId sniperzoom elements exist in DOM
				if($("#sniperzoom-wrapper" + randomId + "").length >= 1 || $("#sniperzoom-zoom" + randomId + "").length >= 1){
				...
				// wrap our plugin
				image.wrap("<div id='sniperzoom-wrapper" + randomId + "'></div>");
				wrapper = $("#sniperzoom-wrapper" + randomId + "");
				...
				wrapper.append("<div id='sniperzoom-zoom" + randomId + "'></div>");
				sniperzoomZoom = $("#sniperzoom-zoom" + randomId + "");
				...
				if(image.hasClass("img-circle")){
					sniperzoomZoom.addClass("img-circle");
				}
				...
				*/
				wrapper.on({
					...
					touchmove: function(e){
						...
						// if finger is out of sniperzoomZoom hide it.
